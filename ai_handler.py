...
retailcrm__get_customers({
  "filter": {"phone": "79060755181"}
})

ВАЖНО: передавай номер телефона ТОЧНО как его написал пользователь, без изменений!
НЕ меняй первую цифру 7 на 8 и не добавляй/убирай цифры!
Если пользователь написал 79060755181 — передай 79060755181, не 89060755181!
